...
<body>
	<div class="container" id="wrapper">
		<div id="header">
			 <div class="logo" style="margin-top:-40px;margin-bottom:8px;"><img src="images/lg.jpg" width="60px" height="50px"/>Crime<span>Control</span></div>
		</div>
...
<div class="row" >
	 <div class="col-sm-3"></div>
		...
		<p style="margin-top:5px;">Copyright &copy; <a href="#" title="email">........... </a>  </p>
